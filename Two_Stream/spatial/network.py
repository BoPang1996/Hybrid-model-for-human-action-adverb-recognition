...
def resnet101(withexpression, pretrained=False, nb_classes=1000, **kwargs):
	"""Constructs a ResNet-101 model.
	Args:
		pretrained (bool): If True, returns a model pre-trained on ImageNet
	"""
	model = ResNet(Bottleneck, [3, 4, 23, 3], withexpression, nb_classes, **kwargs)
	if pretrained:
...
def resnet101_t2(pretrained=False, nb_classes=1000, **kwargs):
	"""Constructs a ResNet-101 model.
	Args:
		pretrained (bool): If True, returns a model pre-trained on ImageNet
	"""
