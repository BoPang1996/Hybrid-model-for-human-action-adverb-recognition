...
model_path = '/Disk8/poli/models/ADHA/Two_stream/T1/spatial'
...
class Data_Loader():
	def __init__(self, BATCH_SIZE, num_workers,input_path, label_path, train_test_split_path,expression_path):
		...
		self.training_set = ADHA( input_path=input_path, label_path=label_path, train_test_split_path=train_test_split_path,expression_path=expression_path, train=True,
		...
		self.validation_set = ADHA(input_path=input_path, label_path=label_path, train_test_split_path=train_test_split_path, expression_path=expression_path, train=False,
		                                      transform=transforms.Compose([
			                                      transforms.ToTensor(),
			                                      transforms.Normalize(mean=[0.485, 0.456, 0.406],
			                                                           std=[0.229, 0.224, 0.225])
